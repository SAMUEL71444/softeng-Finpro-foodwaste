...
export default function Home() {
  ...
  return (
    <main className="min-h-screen bg-gray-50 font-sans text-gray-800 relative">
      ...
      <footer className="bg-white border-t mt-10 py-8 text-center"><p className="text-gray-400 text-sm">© 2026 ResQ-Food Indonesia.<br/>Created by Foodwaste (Computer Science BINUS) 🎓</p></footer>
    </main>
  )
}